    ...
    return ProbeDetailOut(
        ...
        observed=(
            ...
            if detail.observed is None
                ...
                platform=detail.observed.platform,
        ...
        sensors=[
            SensorStateOut(
                ...
                installed_helper_sha256=entry.installed_helper_sha256,
                expected_helper_sha256=entry.expected_helper_sha256,
                tool_name=entry.tool_name,
                installed_tool_version=entry.installed_tool_version,
                expected_tool_version=entry.expected_tool_version,
                tool_platform=entry.tool_platform,
                installed_tool_sha256=entry.installed_tool_sha256,
                expected_tool_sha256=entry.expected_tool_sha256,
                tool_supported=entry.tool_supported,
                tool_source=entry.tool_source,
                tool_path=entry.tool_path,
                tool_compatible=entry.tool_compatible,
            )
